...
CxPolicy[result] {
	...
	result := {
		...
		"issueType": "IncorrectValue",
		"keyExpectedValue": "'ebs_block_device.encrypted' should be set to 'true'",
		"keyActualValue": "'ebs_block_device.encrypted' is not set to 'true'",
...
CxPolicy[result] {
	...
	result := {
		...
		"issueType": "MissingAttribute",
		"keyExpectedValue": "'ebs_block_device.encrypted' should be set to 'true'",
		"keyActualValue": "'ebs_block_device.encrypted' is undefined",
		"searchLine": common_lib.build_search_line(["module", name], []),
