...
CxPolicy[result] {
	...
	result := {
        ...
        "searchKey":         sprintf("google_sql_database_instance[%s].settings.database_flags.cross db ownership chaining", [name]),
        ...
        "searchLine":        common_lib.build_search_line(["resource", "google_sql_database_instance", name], ["settings", "database_flags", "cross db ownership chaining"]),
