...
func main() {
	inputPaths := []string{"assets/queries/terraform/aws/amazon_dms_replication_instance_is_publicly_accessible/test/positive1.tf"}
	outputPath := "/Users/chris.houze/dev/kics"
	sci := model.SCIInfo{
